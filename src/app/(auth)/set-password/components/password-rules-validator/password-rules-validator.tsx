...
interface PasswordProps {
  ...
  validItemClassName?: string;
  invalidItemClassName?: string;
...
export const PasswordRulesValidator: React.FC<PasswordRulesValidatorProps> = ({
  className,
  style,
  rules,
  value,
  ...
  const ruleDefinitions: {
    ...
    minLength: {
      ...
      message: messages.minLength || `Is at least ${minLength} characters.`,
    },
    specialChar: {
    ...
    noSpaces: {
      ...
      message: messages.noSpaces || 'Contains no spaces',
    },
  };
...
const Rule: React.FC<RuleProps> = ({
  ...
  return (
    <li
      className={`${itemClassName} ${valid ? validItemClassName : invalidItemClassName}`}
      style={{
        listStyleType: 'none',
        display: 'flex',
        alignItems: 'center',
